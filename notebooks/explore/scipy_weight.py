...
def weight_constrain(weight, mr):
    ...
    mr:
        ...
        杠杆率
    """
    return (1 / mr) - weight[0] - (2 * (weight[1] + weight[2]))
...
# %%
sol = optimize.basinhopping(func=expect_value,
                            x0=[0., 0., 0.],
                            niter=500,
...
# %%
sol_shgo = optimize.shgo(func=expect_value,
                         bounds=bnd,
                         args=(rf, 7, first_array),
                         constraints=con,
...
# %%
sol = optimize.minimize(fun=expect_value,
                        x0=[0., 0., 0.],
                        args=(rf, 7, first_array),
                        method='trust-constr',
                        jac=jacob,
